...
@section('content')
    ...
    <br/>
    {!! Form::open(['action' => ['CalamitiesController@update', $calamity->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
    <div class="well">
        <div class="row">
    ...
    {{Form::submit('Submit', ['class'=>'btn btn-success'])}}
                <button type="button"  class="btn"><a href="/beap/public/calamityposts">Cancel</a></button></div>
    {!! Form::close() !!}
            </div>
@endsection